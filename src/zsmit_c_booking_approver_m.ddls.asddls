...
@EndUserText.label: 'Booking Projection View Approver'
...
define view entity ZSMIT_C_Booking_Approver_M as projection on zsmit_I_BOOKING_M
{ @UI.facet: [ { id:            'Booking',
                     purpose:       #STANDARD,
  ...
  key booking_id         as BookingID,
      ...
      /* Associations */
      _Traval : redirected to parent ZSMIT_C_Travel_Approver_M,
      _Customer,
      _Carrier,
      _BookingStatus
