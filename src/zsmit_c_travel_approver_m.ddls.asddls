...
@EndUserText.label: 'Travel Projrction View Approver'
...
define root view entity ZSMIT_C_Travel_Approver_M 
...
as projection on ZSMIT_I_TRAVEL_M
{
 @UI.facet: [ { id:              'Travel',
  ...
  key travel_id          as TravelID,
    ...
    /* Associations */
    _Agency,
    _Booking : redirected to composition child ZSMIT_C_Booking_Approver_M,
    _Customer,
    _OverallStatus
}
