...
define view entity ZSMIT_C_Booking_Processor_M
as projection on zsmit_I_BOOKING_M
{
   @UI.facet: [ { id:            'Booking',
                     purpose:       #STANDARD,
  ...
  key booking_id         as BookingID,
      ...
      /* Associations */
      _Traval      : redirected to parent ZSMIT_C_Travel_Processor_M,
      _BookSupplement : redirected to composition child ZSMIT_C_BookSuppl_Processor_M,
      _Customer,
      _Carrier,
      _BookingStatus
